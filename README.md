<p align="center">
  <picture>
    ...
    <img src="docs/assets/cover-light.svg" alt="Chmod Calculator — Octal · Symbolic · Checkboxes — Always In Sync, in the Terminal Workbench style" width="100%">
  </picture>
</p>

<p align="center">
  <a href="https://real-fruit-snacks.github.io/chmod-calculator/"><strong>Live site</strong></a> ·
...
Unix permissions three ways — checkboxes, octal, and symbolic — kept in sync live, special bits included. Styled with the
...
**Offline / airgapped:** grab the zip from the [latest release](https://github.com/Real-Fruit-Snacks/chmod-calculator/releases/latest)
