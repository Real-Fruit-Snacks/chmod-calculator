(function () {
  ...
  function readSize() {
    var s = parseInt(localStorage.getItem("chm-pet-size"), 10);
  ...
  var COLOR_COUNT = 6;
  var petColor = 0;
  try { petColor = parseInt(localStorage.getItem("chm-pet-color"), 10) || 0; }
  ...
  function cyclePetColor() {
    ...
    applyPetColor();
    try {
      if (petColor) localStorage.setItem("chm-pet-color", String(petColor));
      else localStorage.removeItem("chm-pet-color");
    } catch (e) { /* private mode */ }
  }
  ...
  function applyOpacity() {
    var o = parseInt(localStorage.getItem("chm-pet-opacity"), 10);
    if (!(o >= 15 && o <= 100)) o = 70;
    document.documentElement.style.setProperty("--pet-base-opacity", (o / 100).toFixed(3));
  }
  function readCfg() {
    cfgNap = boolKey("chm-pet-nap", true);
    cfgFlee = boolKey("chm-pet-flee", true);
    cfgRead = boolKey("chm-pet-read", true);
    cfgTricks = boolKey("chm-pet-tricks", true);
    cfgSpeech = boolKey("chm-pet-speech", false);
    var c = parseInt(localStorage.getItem("chm-pet-color"), 10);
